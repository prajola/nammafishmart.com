    ...
    <div className="pointer-events-none fixed bottom-5 right-5 z-[100] flex w-[min(92vw,340px)] flex-col gap-2">
      {toasts.map((t) => (
        <button
          ...
          className="toast-in pointer-events-auto flex items-center gap-3 rounded-xl border border-brand-100 bg-white/95 px-4 py-3 text-left shadow-[var(--shadow-card)] backdrop-blur"
        >
