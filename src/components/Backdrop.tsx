/**
 * Ambient sky-blue "splash" backdrop — soft blurred blobs + a few cute
...
export default function Backdrop() {
  return (
    ...
    >
      ...
      <div className="absolute -right-20 top-16 h-72 w-72 rounded-full bg-sky-200/45 blur-3xl [animation:drift-slow_20s_ease-in-out_infinite]" />
      <div className="absolute left-8 top-[45%] h-64 w-64 rounded-full bg-cyan-200/40 blur-3xl [animation:drift_18s_ease-in-out_infinite]" />
      ...
      <div className="absolute -bottom-24 left-1/3 h-72 w-72 rounded-full bg-sky-100/70 blur-3xl [animation:drift_19s_ease-in-out_infinite]" />
      ...
      <span className="absolute right-[20%] top-[30%] h-3 w-3 rounded-full bg-sky-300/50 [animation:bob_6s_ease-in-out_infinite]" />
      ...
      <span className="absolute right-[8%] bottom-[24%] h-3.5 w-3.5 rounded-full bg-cyan-300/40 [animation:bob_7.5s_ease-in-out_infinite]" />
    </div>
  );
}
