      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_360px]">
        ...
        <div className="space-y-3">
          ...
          {cartProducts.map(({ product, qty }) => (
            <div
              key={product.id}
              className="flex gap-4 rounded-2xl border border-brand-100 bg-navy-800 p-3 shadow-[var(--shadow-soft)]"
            >
        ...
        <aside className="h-fit space-y-4 lg:sticky lg:top-24">
          {/* Coupon */}
          <div className="rounded-2xl border border-brand-100 bg-navy-800 p-4 shadow-[var(--shadow-soft)]">
