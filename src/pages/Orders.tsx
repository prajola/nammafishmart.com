      ...
      <div className="space-y-5">
        {orders.map((o) => {
          ...
          return (
            <div
              key={o.id}
              className="overflow-hidden rounded-2xl border border-brand-100 bg-white shadow-[var(--shadow-soft)]"
            >
              <div className="flex flex-wrap items-center justify-between gap-2 border-b border-brand-100 bg-brand-50/50 px-5 py-3">
                <div>
